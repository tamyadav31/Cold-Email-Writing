...
class Chain:
    ...
    def write_mail(self, job, links , name, designation, company):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are {name}, a {designation} at {company}. {company} is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are {name}, {designation} at {company}. 
